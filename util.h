...
#define OAM_SPRITE_Y 0
#define OAM_SPRITE_X 1
#define OAM_SPRITE_TILE 2
#define OAM_SPRITE_FLAGS 3
#define OBJ0_PALETTE_ADDR 0xFF48
#define OBJ1_PALETTE_ADDR 0xFF49
